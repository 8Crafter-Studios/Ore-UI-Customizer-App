...
declare namespace zip {
     ...
     */
    class ZipDeflate extends SyncCodec {
        /**
         * Flushes the data
         *
         * @returns A chunk of compressed data.
     ...
     */
    class ZipInflate extends SyncCodec {
        /**
         * Flushes the data
         */
        flush(): void;
     ...
     */
    export interface ZipReaderConstructorOptions extends ZipReaderOptions, GetEntriesOptions, WorkerConfiguration {
        /**
     ...
     */
    export interface ZipReaderGetEntriesOptions extends GetEntriesOptions, EntryOnprogressOptions {}
     ...
     */
    export interface EntryGetDataOptions extends EntryDataOnprogressOptions, ZipReaderOptions, WorkerConfiguration {}
     ...
     */
    export interface ZipWriterAddDataOptions extends ZipWriterConstructorOptions, EntryDataOnprogressOptions, WorkerConfiguration {
        /**
         * `true` if the entry is a directory.
         *
         * @defaultValue false
    ...
    export class ZipFileEntry<ReaderType, WriterType> extends ZipEntry {
         ...
         */
        getData(
            writer: Writer<unknown> | WritableWriter | WritableStream | AsyncGenerator<Writer<unknown> | WritableWriter | WritableStream>,
     ...
     */
    export interface ZipDirectoryEntryImportHttpOptions extends ZipReaderConstructorOptions, HttpOptions {}

    /**
     * Represents the options passed to `{@link ZipDirectoryEntry}#export*()`.
     */
    export interface ZipDirectoryEntryExportOptions extends ZipWriterConstructorOptions, EntryDataOnprogressOptions {
        /**
