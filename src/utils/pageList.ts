...
export enum CustomizerAppPage {
    ...
    SelectVersionFolder = "select-version-folder",
}
...
type SearchParamTypesInterfaceType = {
    [Page in CustomizerAppPage]: (typeof pageSpecificSearchParams)[Page] extends [] ? never
    :   {
...
export interface SearchParamTypes extends VerifySearchParamTypesIsCorrect<{
